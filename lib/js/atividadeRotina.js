...
const iniciarTabel=()=>{
    ...
    url =dia.value == "Dia..." ? url= getRoot()+'controllers/controllerGetAtvRot': url= getRoot()+'controllers/controllerGetAtvRot?dia='+dia.value; 
    //url= getRoot()+'controllers/controllerGetAtvRot'
    fetch(url)
    .then(res=>res.json()) 
    .then(res=>{
        iniTabel(res)
